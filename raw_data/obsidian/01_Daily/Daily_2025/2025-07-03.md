...
* timing
	* axi ready ( jyt 3 사용 ) - 빠르게 진행하기
	* axi -> debug 뒤로 ( 이미 되어 있음 - axi inbound는 slice 자체가 없음 )
	* mux 안으로 - 전TL님이 진행
* ide option
...
* axi 확인
	* RO관련 VF, PF option 넣기 ( PF0만 본다 등 )
* irene email 확인
* ide tc debugging
	* viktor email
* 미국 업데이트 ( power define + atb ) 확인
### Day planner

- 10:00 - 11:30 [[업무]] #에너지90 
	- 내용 :
		- 피렌체 interrupt 정리
		- ide interrupt 추가
	- 기분 : 
		- 일단 다른거보다 우선 순위 높게 내가 할 일에 집중
		- 아주 에너지 높음 ( 당분간 이런 부분도 필요함 - RTL Freeze 목적 )
### Review

- Claude Code 이용해서 내가 짠 코드의 완성도를 높이는 방법
- 아니면 디자인에서 검증해서 보는 방법
