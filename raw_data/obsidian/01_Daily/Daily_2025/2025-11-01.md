...
mctp logic 검증 ( spec + claude code )
tdisp , xt mode logic 검증 ( spec + claude code )
나의 주식 자산 정리 ( claude code ) - 각 종목 페이지
행복꾸러미 정리
AI 지능 적극적으로 활용하기
Restart 는 interrupt 필요 없나.. ? 
### Day planner
...
- 12:30 - 13:00 [[업무]] #에너지80 
	- claude code 활용해서 mctp asm tb 만들기
- 13:00 - 14:00 [[업무]] #에너지80 
	- 팀장님과 이야기 
		- 삶에 대한 이야기 ( 자식 )
		- 평가에 대한 이야기 ( 다행 )
- 14:00 - 15:00 [[업무]] #에너지80 
	- claude code 활용해서 mctp asm tb 만들기 !! AI 최대한 활용 !!
	- 생각보다 한도가 금방 끝난다. 그리고... 아직 부족하긴 하다... 흠... 
- 15:00 - 15:51 [[업무]] #에너지70 
	- 집에서 claude code 작업을 위해 code 작업 진행
	- 흠... 직접 쓸수 있는게 제일이고, claude code 사용량이 좀 부족하다.
	- open ai codex 도 고민해보자. gemini는 무료 버젼으로 최대한 활용 
