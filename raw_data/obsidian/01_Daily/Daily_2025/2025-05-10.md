...
- 6:00 - 8:00 [[Life Management Tool 개발]] #에너지90 
	- 주식 분석 도구가 이제 어느 정도 안정화가 되었습니다.
		- Agent가 tool을 각각 1번씩 부르도록 설정
		- 특정 input을 넣도록 설정
		- 각 Agent tool의 역할 설정
		- system prompt 설정
		- web search 기능 추가 ( serp api - 이건 보완 필요 )
- 12:00 - 13:00 [[식사]] #에너지80 
	- 오징어 초무침 + 납작만두 !!
- 15:00 - 18:30 [[미야와 함께 하기]] #에너지80 
	- 필리핀 세부 비행기 예약 !!
	- 고래상어, 상어고래 보러갑니다 !!
	- 크림슨 리조트 막탄 https://naver.me/5gFBcDx8
- 18:30 - 19:00 [[식사]] #에너지70 
	- 카레 맛나게 잘 먹음 !!
- 20:00 - 20:50 [[Life Management Tool 개발]] #에너지70 
	- Firecrawl setting 해서 뭔가 되네요
	- extract + search 기능 써보기
