...
- IDE 설계
- TC Debugging
- MSG Handler Integration ( + RX ) + CSR 생성
### Day planner

- 6:00 - 12:00 [[업무]]
	- Custom TC Debugging 및 정리
	- TC Debugging Review
	- MSG Handler Review
- 12:00 - 12:40 [[식사]]
- 12:40 - 13:00 [[업무]]
	- 
- 13:00 - 14:00 [[미팅 or 세미나]]
- 14:00 - 19:00 [[업무]]
	- Custom TC Debugging 및 정리
		- IDE TC Debugging
		- Custom TC Debugging
...
오전에 TDISP 설계 ( 못함 )
TC Debugging 위주로 함
MSG Handler Integration ( 성아 TL님 완료 )
Unacked FLIT Outstanding 디버깅 
TL Application Error ( 끝 )
### Thank you
