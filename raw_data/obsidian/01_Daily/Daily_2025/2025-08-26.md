...
- 모든 Fail TC 다 돌려보기
- Lint Fix
- IDE Option Option 추가
- OB Discard rollback option
- tdi error - bme req stop oring ( bme disable )
- ats 기능 쓰기??
- hct ib, ob count 증가 추가, 설정 추가, SFR 설정 제거
- ip 내부 msg handling 추가
- 성아tl에게 디버깅 레지스터 알려주기
- 승훈 tl에게 xt 구현
- ohc option
- mag receiver 복사 ( firenze -> gzr )
- pcie receiver 복사
- unlock 옵션
