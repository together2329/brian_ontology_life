...
- 7:20 - 8:00 [[일상]] #에너지70 
	- 아침 + 나갈 준비
- 8:15 - 9:00 [[FAIL TC 정리 및 분석]] #에너지70 
	- weekly report 작성 및 tc 정리
- 9:00 - 9:50 [[Custom TC Debugging]] #에너지70
	- custom tc 분석
- 11:30 - 12:30 [[식사]] #에너지70 
	- 서브웨이
- 12:30 - 14:20 [[Custom TC Debugging]] #에너지80 
	- Weeky Report 및 TC 확인
		- weekly report에서 예상치 적음
		- TL , Custom 증가 개수
	- Custom TC에서 UC 2MHz <-> 500Mhz TC 제외
- 14:20 - 14:50 [[Custom TC Debugging]] #에너지80 
	- 확실히 정리하면서 하니 좋음
- 14:50 - 15:40 [[Custom TC Debugging]] #에너지80 
	- Lane Width, Speed 변경 이슈
	- L0 (4lane) -> Config Width Update -> L0(1lane) -> Speed Change
	- Speed Chage에서 Link Width 이슈 ( 4 lane <-> 1 lane mismatch )
	- L0(1lane) 변경시, 정보가 다 저장 되지 않은 상태에서 비동기로 Speed Change를 진행해서 문제 된듯
- 15:40 - 16:10 [[휴식 & 쉼호흡]] #에너지80 
	- 커피 테이크 아웃

### Review

중간 중간 하고 있는 일을 최대한 자세히 적을 필요가 있음
쉼호흡 + 자세히 !!
### Thank you
