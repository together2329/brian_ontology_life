...
1. **Security Handler DCG**: DCG 기능 추가 및 TDISP Enable 관련 보고
2. **Async FIFO List Update**: Firenze 및 HLD 양쪽 모두 업데이트 리스트 정리
3. **Admin**: Qtest TBD TC -> Not Required 로 변경 및 Regression 제외 요청
4. **New ECN / Narrow Burst**: 관련 에러 카운터 및 지원 여부 확인
...
- 8:20 - 9:00 [[식사]] #에너지80 
	- 떡과 비타민 음료 그리고 두유
- 9:00 - 10:00 [[일상]] #에너지70 
	- 출근하면서 차에서 gpt랑 영어 대화
	- daily review 어떻게 할 지 이야기
- 10:00 - 12:00 [[업무]] #에너지60 
	- mctp review
		- exception case 최대한 많이 보기
	- hal, tl 어떻게 보면 좋을지 설명
	- hld debugging
		- b response 여전히 전파가 되지 않음
	- msg hld csr update...
		- 역할의 문제 
	- hld msg fail issue
		- mem write 되지 않음
		- msg pending 되지 않음
	- 뭔가 어제의 여파... 상당히 피곤하다... ㅠㅠ
- 12:00 - 13:00 [[식사]] #에너지80
	- 성현, 길봉 TL님과 식사
	- 커피 테이크 아웃
- 13:00 - 15:20 [[업무]] #에너지90
	- Security Handler DCG 구현 완료
	- 가이드 업데이트 완료
	- MCTP FW 팀과 논의 시작
	- TDISP 관련 AEAD 검증 거의 완료 (Good)
