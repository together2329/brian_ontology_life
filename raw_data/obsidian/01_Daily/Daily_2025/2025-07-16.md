...
- core clk mux -> 관련 다시 한 번 더 confirm 받기
    - 피렌체 임플팀 참조
- Firenze Imple팀 리포트 공유
- 이슈 2개 분석
	- bresp error
	- axi hang.. 
- 김승훈TL님 피렌체 perforce , db 요청
- 양시훈TL님 피렌체 perforce , db 요청
...
- 7:40 - 9:30 [[업무]] #에너지70
	- 메일 읽기 
	- I2C, I3C 관련 답변
		- I3C/SMBUS 관련 Form Factor Spec
	- Regression Status 확인
	- 지형TL님 shelve 알려드리기
	- 성아TL님 msg handler 관련 디버깅 요청
	- 승훈TL님 시훈TL님 firenze perforce 권한 요청, project 권한 요청
- 9:30 - 11:48 [[업무]] #에너지70
	- custom tc req stop 분석
		- 각각의 원인 다 분석 후 alexander에게 공유
		- 모두 tb issue
	- ide fail tc 분석
		- 오늘 시간 되면 진행
	- msg handler ( firenze )
