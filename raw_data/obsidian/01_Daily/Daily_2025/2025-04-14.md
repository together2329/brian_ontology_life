...
* GZR
	...
	* 구현
		* ![[GZR_Task#^GZRMAIN2]] 
* Ratel2
	* ![[MSG & Shared SRAM#^RMSG1]] 

## Day planner

- 13:00-14:00 ![[GZR_Task#^GZRMAIN1]]

---

Custom TC Issue 빠르게 대응

* 14:00-14:20 ![[Custom TC#^GZRCUS3]]  
* 14:20-14:40 ![[Custom TC#^GZRCUS4]]  
* 14:40-15:00 ![[Custom TC#^GZRCUS5]]  

---

* 15:00-16:00 Weekly 회의
	* 특허, 학술 논문 작성 ( Repair )
	- VDM RX, TX
	- Shared SRAM Read Write
	- GEN1 Flit Mode Timing 
	- GZR Custom TC ... 증가율..
	- 피렌체.. SRAM 추가(size up)

---

- 16:00-16:20 Data Link Dayer 질의 응답 ( with 김성아 TL님 )
	- Selective NAK, Standard NAK
	- Shared Credit 관련 메커니즘 ( 김TL님 도움 받음 )
- 16:20-16:50 Firenze SRAM Requirement 전달하기
	- Firenze SRAM Requirement 전달하기
		- 확인해보니 RF 2P 기준으로 만들어짐 ( Integration은 가능 )
		- 추후 SRAM 2P 기준으로 다시 생성 필요할 듯 ( 장보선 TL님이 알려주기로 함 )
---

- 16:50-18:00 ![[GZR_Task#^GZRMAIN1]]
