...
- 8:40 - 9:10 [[업무]] #에너지50
	- 메일 확인 ( 스트레스 )
- 9:10 - 9:30 [[FPGA Dual Port Sim Issue 살펴보기]] #에너지50
	- USE_FPGA_X2 define 살펴보기
	- simulation 다 돌려보기
	- FPGA DP Sim 잘됨
	- 최근에 추가된 phy 가 검증이 안 된 것임
- 9:30 - 11:45 [[FAIL TC 정리 및 분석]] #에너지80
	- fail tc의 원인은 bar4 관련 수정과 연관이 있음
...
vnc://192.168.45.182/에서 사용자의 컴퓨터 화면에 연결하거나 Finder 사이드바에서 ‘Brian의 M
### Review
