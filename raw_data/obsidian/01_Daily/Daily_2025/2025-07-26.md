...
- [[AION TOP SDC 작성]]
- [[Linkdown 시 completion lock 전송 이슈]]
...
- 7:20 - 8:00 [[Custom TC Fail 분석 및 전반적인 요약]] #에너지70 
	- custom tc status 확인
		- custom l0rl1
		- custom l0l1
		- custom
	- fail tc regression 돌리기 
- 8:00 - 8:20 [[식사]] #에너지70
- 8:00 - 8:50 [[Custom TC Fail 분석 및 전반적인 요약]] #에너지70 
	- 다음주 pass rate을 1% 올리려면 IDE랑 Custom에서 많이 올려야 한다
	- 우선 custom fail tc 다 돌려 놓음
		- register access는 다 잡자 !!
- 8:50 - 10:50 [[AION TOP SDC 작성]]
	- initial sdc 작업 완료
	- 우선 update
	- pcie sub top도 살려서 보기 
	- 그 다음에 ucie sub top 살려서 보기
- 11:00 - 12:40 [[치료]] 
	- 병원 다녀오기
- 12:40 - 15:00 [[Custom TC Fail 분석 및 전반적인 요약]] 
	- DB 릴리즈 준비 
		- fix 한 부분 다 merge 하기
	- Custom TC, Submit TC 등 다 돌리기
