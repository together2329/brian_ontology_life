...
- Grizzly Ridge SDC Review
- Grizzly Ridge Design Review
	- AXI user
	- security 
	- IP Bug List
### Day planner
...
- 6:20 - 11:40 [[업무]]
	- OHC Guide 전달
		...
		- OHC-C requester segment for mem req ( non ide tlp )
	- Reset TC Path 전달
	- DV Status 정리 -> Jay에게 송부
	- Custom TC Add 가능한듯 
		- 3개 추가함 
	- Ilya에게 custom l0rl1 list 추가 ( jenkins ) 
		- 오후에 run 예정
	- jenkins 나도 run 가능하네
		- 나중에 ide progress 끌어올리기
	- Custom List 분석
		- Fail TC 분석
			- 
