...
ready slice
axi debug slice
timing analysis ( place)
ip bug list ( 급선무 )
spec 6.4 review ( 급선무 )
pcrc override by spec
pcrc and operation
pcrc -> ts by ide control register
...
- 9:00 - 12:00 [[Custom TC Debugging]] #에너지70 
	- l0rl1 에 이슈 있음 - link1 test가 안됨
- 12:00 - 13:00 [[공부]] #에너지80
	- 전체 구조 짜기 + 테스트 
- 13:00 - 14:00 [[Custom TC Debugging]] #에너지70
	- TB Issue가 너무 많음...
	- 얼른 알렉산더가 와야 할 듯
- 14:00 - 14:50 [[미팅 or 세미나]] #에너지70
	- IDE DV support
	- Debug Register TC 더 설명 추가하기
- 14:50 - 
