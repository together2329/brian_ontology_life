...
- 3:00 - 6:00 [[공부]] #에너지70
	...
	- table 만들기 성공
		...
		- 읽어서 분석 성공
- 9:50 - 11:50 [[업무]] #에너지50
	- custom l0l1 에 ucFW update 후 sim 진행
	- 이메일 읽기
	- 세미나 검토
	- Upconfigure 이야기 ( Flit Mode 지원 안함 )
	- lane width + link speed 변경을 max gen5로 설정
	- Ratel Msg RX 대응 ( Msg,MsgD )
	- custom list update ( confluence )
	- 전체 TC Prorgess.. 95%택도 없음 -> 이걸로 스트레스 받음
	- FPGA shared credit 관련 요청 ( dedicated 없이 테스트 )
- 11:50  - 13:00 [[공부]] #에너지50 
	- edgar api... 계속 실패 ( 뭔가 문제 있음 )
- 12:30 - 12:50 [[식사]] #에너지50
	- 제육 볶음 ( 너무 급하게 먹은 듯 )
- 12:50 - 14:30 [[업무]]
	- Custom TC L0RL1 요청
	- TL Regression 다시 요청
	- L1.sub dual port regression 다시 요청 
- 14:30 - 15:30 [[미팅 or 세미나]] #에너지50
- 15:30 - 20:30 [[업무]] #에너지50
	- FPGA Flit Mode PA 분석
	- FPGA ACK, NACK 분석 ( Flit Mode )
	- custom lane test 및 list 만들어서 제공
	- link speed, width update TC 패스 확인
	- AION Bus논의 (Msg)
### Review
