...
UNLOCK 일 때 나간 Req가 Completion Timeout이 되지 않음
- HAL에서 Enable + Run이 아닌 경우 -> FLR Flush
- Unlock일때, T=0 , XT=0 으로 나갈 수는 있음
- 그런데... Run일때 나간게 Run 아닐때 Fail, 
- Unlock 이랑 Run이랑 구분자가 있어야 하는데... 이건 상당히 어려움
- 그냥 Unlock일 때 안 쏘도록 강제하는 수밖에 없음
...
AEAD - IDE Fail Msg 전송 필요

async fifo
msg tb 적용
sign key

하재진 TL님의 MSG 관련 이슈 살펴보기 
HLD Direct 전송에서 MSG 전송 안되는 이슈
### Day planner

- 8:50 - 9:50 [[업무]] #에너지80 
	- antigravity google tool 사용
- 10:00 - 11:45 [[업무]]
	- post sim 환경 리뷰
	- 쉬엄 쉬엄 
- 11:45 - 12:45 [[식사]]
	- 건강한 밥상
- 13:00 - 15:00 [[업무]]
	- AEAD 기능 IDE Fail Msg 필요
	- AEAD 관련 counter에 clock dcg 는 제외 필요 ( always on clock 필요 )
- 15:00 - 16:00 [[업무]]
	- TBD TC Review
		- 40여개 TC 제외
- 16:00 - 17:00 [[미팅 or 세미나]]
	- blankeT RoadMap 듣기
- 17:00 - 18:00 [[업무]]
	- Shared Credit, Dedicated Credit 관련 논의 
		- requirement 구체화하기
### Review
