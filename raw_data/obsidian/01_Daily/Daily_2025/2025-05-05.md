...
- 6:30 - 7:50 [[Life Management Tool 개발]] #에너지90 
	- dataviewjs 제거 완료 ( binary 를 text 로 변환 먼저 해야함 )
	- 날짜를 따로 받아서 merge 완료
	- 일단 나의 Daily Note에 질의하고 응답 받는 시스템은 구축 완료
	- 여기에 Task 까지 Parsing 하면 좋을 듯 ( 프로젝트 별로 진행 상황 물어볼 때 )
	- 행복꾸러미 기반으로 분석 요청할 때 좋을 듯
	- Memory 기능 공부
	- ![[Pasted image 20250505075213.png]]

- 20:00 - 21:15 [[Life Management Tool 개발]] #에너지90 
	- Eleven Labs로 질문하고, 구글 드라이브에서 데이터 받아서, AI Agent로 답변 받기 성공
	- 이걸 Slack에도 저장 !! 굿 !!
	- ![[Pasted image 20250505211814.png]]
