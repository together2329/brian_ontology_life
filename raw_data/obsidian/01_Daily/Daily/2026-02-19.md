...
- GEN7 IP로 Link Up 까지는 Debugging하기
	- core -> reg top 일부는 연결 필요함 ( 직접 진행하기 )
	- ips쪽은 길봉TL님에게 넘기기

- 출장 최종 정산을 위한 기안 작성하기
	- iflow 출장 완료 보고서 쓰기
	- 로밍 비용
- MCTP 쪽을 위해 pmc, admin 쪽에 GDMA 할당 받기 ( 1개씩 ) ( 완료 )
- 출장 정산
	- 중간 정산 끝나면 로밍 비용 정산 올리기
- GEN7 Project    
    - GEN7 IP 교체 ( 완료 )
        - Grizzly Ridge 기준으로
    ...
    - 밀라노 Synthesis Report 필요
        - HPDF Block 분리
- MSG Routing 확인 필요 ( CLD 에서 확인 )
    - CLD 에서 VDM 혹은 MSG 확인하기 ( Int Msg or VDM )
- 종호TL님 옵션 답변
