...
- `life/imports/global_data_centers_20260717/physical_operator_disclosure_registry.jsonl`: validated crosswalk from 31 major physical data-center operators to their reviewed portfolio and financial profiles, official evidence URLs, page-level registries where available, and comparison boundaries.
