...
PROFILED = [
    ...
    entity("H5_Data_Centers", ["H5", "H5 Data Centers"], "reviewed_current_US_directory_JV_managed_area_power_AI_and_private_financial_boundary", ["dc_h5_data_centers_us_wholesale_colocation_and_managed_portfolio", "company_h5_data_centers", "h5_data_centers_registry.jsonl"], "Seven operator-tagged OSM objects route to current H5 facility cards. A Cleveland name-and-website match and a Quincy name-and-website match with raw legacy Intuit operator are retained as related evidence without making Intuit an alias. Thirty-two directory labels, thirty-one listed addresses, twenty-five markets, multi-building cards, Hyscale, HyscaleIX, managed area, power, GPUs and financials remain separate."),
    entity("O2_Czech_Republic_and_CETIN_data_center_boundary", ["O2 Czech Republic a.s."], "reviewed_CETIN_owned_O2_service_current_address_power_certification_and_parent_financial_boundary", ["dc_o2_czech_cetin_owned_colocation_cloud_and_service_portfolio", "company_o2_czech_republic", "o2_czech_data_center_registry.jsonl"], "Four O2 Czech Republic a.s.-tagged OSM objects exactly match the four current provider address entries for Stodulky, Chodov, Brno/FASTER and Uherske Hradiste/Monaco. The current support and technical roster additionally names Nagano and Hradec Kralove without current public addresses; O2 service, CETIN physical ownership, certification wording, reserved input power, live load, GPUs and financials remain separate."),
    entity("PowerHouse_Data_Centers", ["PowerHouse"], "reviewed_private_US_hyperscale_AI_development_project_card_JV_power_and_financial_boundary", ["dc_powerhouse_us_hyperscale_AI_development_and_JV_pipeline", "company_powerhouse_data_centers", "powerhouse_data_centers_registry.jsonl"], "Four PowerHouse-tagged OSM objects route to ABX-1 and the Chesterfield CTP cluster. One additional name-only CTP-03 construction polygon is retained as related evidence without broadening the alias. Thirteen current sitemap cards, two home-only labels, current and future utility power, project buildings, sold and leased states, CoreWeave demand, liquid-cooling readiness, JVs and private financials remain separate."),
    entity("Rowan_Digital_Infrastructure", ["Rowan Green Data LLC"], "reviewed_private_US_hyperscale_AI_project_phase_power_financing_and_legacy_operator_boundary", ["dc_rowan_us_hyperscale_AI_power_and_financing_pipeline", "company_rowan_digital_infrastructure", "rowan_digital_infrastructure_registry.jsonl"], "Four Rowan Green Data LLC-tagged OSM building geometries route to one current Percheron campus card. The six project identifiers inside four current cards, Bauxite phases, regional power envelopes, 230-MW operating headline, current Rowan brand, legacy legal operator, owner label, debt financing, customer GPUs and private financials remain separate."),
    entity("TIM_Enterprise_and_Noovle", ["TIM", "Noovle S.p.A", "Noovle S.p.A.", "TIM - Google"], "reviewed_current_Italian_certificate_roster_power_equipment_cloud_GPU_and_parent_financial_boundary", ["dc_tim_noovle_italy_cloud_AI_and_data_center_portfolio", "company_tim_noovle_enterprise", "tim_noovle_data_center_registry.jsonl"], "Five TIM, Noovle or TIM-Google OSM objects reconcile to current certificate-backed sites. An unnamed TIM point and the Trento Nord telecom exchange remain related but outside the current sixteen-site Noovle roster. Active and planned sites, IT/POD/installed power, cogeneration, Google equipment, TIM GPUs and diversified financials remain separate."),
    entity("Turkcell_and_TDC", ["Turkcell", "Turkcell Superonline"], "reviewed_Turkiye_managed_commercial_new_generation_legacy_power_GPU_revenue_and_parent_financial_boundary", ["dc_turkcell_tdc_turkiye_data_center_cloud_and_AI_portfolio", "company_turkcell_tdc_data_centers", "turkcell_tdc_data_center_registry.jsonl"], "Five operator-tagged OSM objects route to Turkcell/TDC: three match current new-generation sites, Kartal was phased out in 2025 and Edirne remains outside the disclosed four-site roster. A sixth named but operator-untagged Yenibosna point is retained only in the page registry. Site-count, power, GPU and financial perimeters remain separate."),
    entity("VNPT_Group", ["VNPT"], "reviewed_Vietnam_eight_center_rack_Hoa_Lac_power_GPU_expansion_and_group_financial_boundary", ["dc_vnpt_vietnam_data_center_cloud_and_AI_portfolio", "company_vnpt_group_data_centers", "vnpt_data_center_registry.jsonl"], "Four VNPT-operator OSM objects cover Tan Thuan, Cau Giay, Hoa Lac and Nam Thang Long. Three reconcile to current provider-named or 2026 expansion sites; Cau Giay remains outside the incomplete eight-site roster. Racks, footprints, power, GPUs, project investment and group financials remain separate."),
    entity("Yandex_Group_and_legacy_Finland_boundary", ["Yandex"], "reviewed_current_Russian_four_data_center_zone_power_historical_GPU_financial_and_legacy_Nebius_boundary", ["dc_yandex_russia_cloud_data_center_GPU_and_legacy_nebius_boundary", "company_yandex_group_cloud_and_data_centers", "yandex_data_center_registry.jsonl"], "Four raw Yandex-operator OSM objects route to this profile: three current Russian address matches and one legacy Finland building now inside the Nebius successor boundary. Two additional Finland geometries are retained in the page registry. Physical addresses, zones, buildings, mapped footprint, current power, dated GPUs, Cloud economics and successor ownership remain separate."),
