...
LAYER_COMPARISON = [
    ...
    },
    {
        ...
        "evidence_state": "Thirty operators now have a scope-preserving crosswalk, but site economics, utilization and return on capital remain limited, especially for private firms.",
