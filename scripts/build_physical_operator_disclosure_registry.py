...
SPECS = [
    ...
    spec("Telehouse", "company_kddi", ["dc_telehouse_global_connectivity_portfolio"], "North_America_Europe_and_Asia", "public_parent_with_segment_or_platform_boundary", "31 official global brochure location labels aggregating more than 45 data-center sites", "City and campus labels, physical buildings, average 20 MVA, design power, current IT load, AI test labs and 16 OSM objects use different scopes.", ["life/imports/global_data_centers_20260717/telehouse_official_location_registry.jsonl", "life/imports/global_data_centers_20260717/telehouse_official_location_summary.json"]),
