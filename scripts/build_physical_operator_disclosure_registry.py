...
SPECS = [
    ...
    spec("TenPeaks_and_legacy_Spark_New_Zealand", "company_tenpeaks_and_spark_new_zealand", ["dc_tenpeaks_new_zealand_portfolio_and_legacy_spark_boundary"], "New_Zealand", "private_equity_controlled_operator_with_public_parent_minority_look_through", "eleven current facilities, more than 23 MW, more than 2,500 racks and a 130-MW-plus development pipeline", "Nine current operating map labels, a plausible but unconfirmed eleven-component reconciliation, legacy 16-site Spark roster, development MW, OSM footprints, pre-sale financials, transaction metrics and Spark's 25-percent associate use different scopes.", ["life/imports/global_data_centers_20260717/tenpeaks_legacy_spark_facility_registry.jsonl", "life/imports/global_data_centers_20260717/tenpeaks_legacy_spark_facility_summary.json"]),
    spec("IXcellerate", "company_ixcellerate", ["dc_ixcellerate_moscow_campus_portfolio"], "Moscow_Russia", "private_with_audited_UK_consolidated_parent_and_Russian_statutory_entities", "five operating facilities with 11,329 full-design card racks and 127.7 MW of published card power plus South and Veshki full-build plans", "Current cards, the provider's 10,329 end-2025 racks, staged MOS3 delivery, installed grid power, campus plans, statutory legal entities, OSM objects and hosted AI readiness use different scopes.", ["life/imports/global_data_centers_20260717/ixcellerate_official_facility_registry.jsonl", "life/imports/global_data_centers_20260717/ixcellerate_official_facility_summary.json"]),
    spec("Leading_Edge_Data_Centres", "company_leading_edge_data_centres", ["dc_leading_edge_data_centres_australia_regional_portfolio"], "New_South_Wales_Australia_with_Victoria_and_Queensland_pipeline", "private_with_public_investor_portfolio_look_through", "six current NSW provider cards with a 3.975-MW total-site-capacity checksum and 3,034 square metres of available area", "Current cards, historical 75-rack first-six design, older 20/26/30-plus rollout plans, six OSM objects, AI-oriented business names, investor funding and WHSP portfolio results use different physical, lifecycle and financial scopes.", ["life/imports/global_data_centers_20260717/leading_edge_official_facility_registry.jsonl", "life/imports/global_data_centers_20260717/leading_edge_official_facility_summary.json"]),
    spec("Prime_Data_Centers", "company_prime_data_centers", ["dc_prime_data_centers_north_america_emea_portfolio"], "North_America_and_EMEA", "private_with_named_institutional_investors_and_public_investor_look_through", "nine current location pages with 28 mixed-lifecycle cards, 1.09 GW of campus headlines and 760 MW of numeric card capacity against a 4-GW-plus roadmap", "Current pages, 13/14 campus headlines, 22/29 other portfolio counts, OSM objects, customer GPUs, project investment plans and private financial disclosure use different scopes.", ["life/imports/global_data_centers_20260717/prime_data_centers_official_facility_registry.jsonl", "life/imports/global_data_centers_20260717/prime_data_centers_official_facility_summary.json"]),
    spec("TierPoint", "company_tierpoint", ["dc_tierpoint_us_enterprise_and_ai_colocation_portfolio"], "United_States", "private_with_securitized_collateral_operating_metrics", "40 current specification-sheet records versus a 33-facility securitized pool with 96 MW critical load", "Provider page groups, sheet records, collateral assets, heterogeneous area fields, design ceilings, customer hardware and standalone company financials use different scopes.", ["life/imports/global_data_centers_20260717/tierpoint_official_facility_registry.jsonl", "life/imports/global_data_centers_20260717/tierpoint_official_facility_summary.json"]),
    spec("Kao_Data", "company_kao_data", ["dc_kao_data_uk_ai_and_advanced_computing_portfolio"], "United_Kingdom", "private_with_statutory_consolidated_group_and_public_investor_associate_reporting", "seven current facility codes plus one Park Royal plan, 128.2 MW of numeric cards, 41.6 MW of operational cards and a separate 160 MW-plus mixed-lifecycle headline", "Current cards, investor operating and construction measures, Harlow's ultimate envelope, customer GPUs, ESG perimeters, statutory and management financials and four OSM objects use different scopes.", ["life/imports/global_data_centers_20260717/kao_data_official_facility_registry.jsonl", "life/imports/global_data_centers_20260717/kao_data_official_facility_summary.json"]),
    spec("Verne", "company_verne", ["dc_verne_northern_europe_ai_colocation_portfolio"], "Iceland_Finland_UK_transition_France_and_Norway_pipeline", "private_with_latest_audited_UK_consolidated_group_accounts", "two retained operating campuses, two completed Finnish divestments, one UK facility under a signed sale agreement, a 70 MW initial build and 500/180 MW plans against 52.3 MW FY2025 installed capacity", "Installed capacity, campus cards, substation capacity, construction MW, grid requests, master plans, customer GPUs, divestments and audited financial perimeters use different scopes.", ["life/imports/global_data_centers_20260717/verne_official_facility_registry.jsonl", "life/imports/global_data_centers_20260717/verne_official_facility_summary.json"]),
    spec("Cogent_Communications", "company_cogent_communications", ["dc_cogent_classic_edge_and_network_data_center_portfolio"], "North_America_and_Europe", "public_listed_diversified_network_operator_with_audited_companywide_financials", "87 current marketed classic plus 86 edge data centers versus 187 buildings, 2.1 million square feet and 213 MW at FY2025 year-end", "Current marketing, dated statutory buildings, visible markets, exact European addresses, carrier-neutral service locations, floor space, power, OSM objects, GPUs and companywide financials use different scopes.", ["life/imports/global_data_centers_20260717/cogent_official_data_center_registry.jsonl", "life/imports/global_data_centers_20260717/cogent_official_data_center_summary.json"]),
